...
export class AccesorioComponent implements OnInit {
  ...
  trackId(index: number, item: IAccesorio): number {
    return item.id!;
  }

  delete(accesorio: IAccesorio): void {
    const modalRef = this.modalService.open(AccesorioDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: IAccesorio[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
